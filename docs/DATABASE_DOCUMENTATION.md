...
| **SecurityQuestion** | Password recovery Q&A | `security_questions` | Bcrypt-hashed answers, linked to question templates |

| **SecurityQuestionTemplate** | Predefined question catalog | `security_question_templates` | Admin-managed; soft-deleted when in use |
...
| **Security questions** | bcrypt-hashed answers for password recovery (admin-managed question templates) |
...
| 13 | `add_suspension_model` | 2026-06-22 | Suspension model |

| 14 | `add_security_question_templates` | 2026-07-15 | SecurityQuestionTemplate model + seed data |
