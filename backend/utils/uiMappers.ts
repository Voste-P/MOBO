...
export function toUiOrderSummary(o: any) {
  ...
  return {
    ...
    items: (o.items ?? []).map((it: any) => ({
      ...
      priceAtPurchase: it.priceAtPurchasePaise != null ? paiseToRupees(it.priceAtPurchasePaise) : 0,
    })),
    total: paiseToRupees(o.totalPaise),
    soldBy: o.soldBy || null,
    orderDate: safeIso(o.orderDate) || null,
    status: o.status,
...
export function toUiOrder(o: any) {
  ...
  return {
    ...
    settlementMode: (o as any).settlementMode,
...
export function toUiTicketForBrand(t: any) {
  return {
    ...
    orderId: t.externalOrderId || t.orderId,
